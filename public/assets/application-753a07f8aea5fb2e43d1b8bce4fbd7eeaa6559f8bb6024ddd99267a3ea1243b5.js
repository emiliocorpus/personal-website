...
var Body = React.createClass({
	...
	render: function () {
		return React.createElement(
			...
			React.createElement(BodyButtons, null),
			React.createElement(AboutMe, null)
		);
	}
});
var BodyButtons = React.createClass({
	displayName: "BodyButtons",

	render: function () {
		return React.createElement(
			"div",
			{ id: "body-buttons-container", className: "debugger" },
			React.createElement(AboutMeButton, null),
			React.createElement(ProjectsButton, null),
			React.createElement(BlogButton, null)
		);
	}
