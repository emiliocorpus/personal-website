	...
	render: function () {
		return React.createElement(
			...
			React.createElement(
				...
				". I am interested in any position that can allow me to grow and increase my budding programming knowledge. My ultimate goal is to become a senior-level software engineer but I am open to exploring different avenues and experiences along the way! My current areas of expertise include ",
				React.createElement(
					"em",
					null,
					React.createElement(
				...
				". I am easily adaptable and able to learn things fairly quick (I started web development in early 2015). I consided myself to be a compassionate worker and am very family-oriented.",
				React.createElement(
					"p",
					null,
					"Outside of coding and builing web-apps, I am an avid ukulele player, basketball enthusiast, die-hard Raider fan, and a well-seasoned Netflix veteran!"
				)
			),
			React.createElement(
				"div",
				{ id: "about-table", className: "debugger" },
				React.createElement(
					"div",
					{ className: "debugger" },
					React.createElement(
				...
				React.createElement(
					"div",
					{ id: "education", className: "debugger" },
					React.createElement(
						"h3",
						null,
						"Education"
					...
					React.createElement(
						...
						React.createElement(
							"li",
							{ className: "list-style-none" },
							"DevBootcamp is an 18+ week program in which students learn the fundamentals of Object Oriented Design, web development, team building, peer programming, but most importantly, how to efficiently learn new concepts and languages on the fly. ",
				...
				React.createElement(
					"div",
					{ id: "experiences", className: "debugger" },
					React.createElement(
						"h3",
						null,
						"Previous Employment"
					...
					React.createElement(
						"h4",
						null,
						"DevBootcamp Teaching Assistant "
					),
					React.createElement(
						"p",
						null,
					...
					React.createElement(
						"h4",
						null,
						"John Muir Emergency Room Scribe"
					),
					React.createElement(
						"p",
						null,
					...
					React.createElement(
						"h4",
						null,
						"Neil Okamura, D.O., Part-Time Receptionist/Clerk"
					),
					React.createElement(
						"p",
						null,
	...
	render: function () {
		return React.createElement(
			...
			React.createElement(
				"p",
				null,
				"I APOLOGIZE, THIS AREA IS CURRENTLY UNDER CONSTRUCTION, PLEASE COME BACK AT A LATER TIME, THANK YOU!"
			)
		);
	}
});
var Content = React.createClass({
	...
	render: function () {
		...
		if (this.props.displayedContent === "about") {
			display = React.createElement(About, null);
		} else if (this.props.displayedContent === "projects") {
			display = React.createElement(Projects, null);
		} else if (this.props.displayedContent === "blogs") {
			display = React.createElement(Blogs, null);
		}
		return React.createElement(
			"div",
			{ id: "content-container", className: "debugger" },
			display
		);
	}
});
...
var AboutButton = React.createClass({
	...
	render: function () {
		return React.createElement(
			"div",
			{ className: "debugger sidebar-button" },
			React.createElement(
				"a",
				{ href: "#", className: "button-link", onClick: this.handleClick },
				"About Me"
			)
		);
	}
...
var Sidebar = React.createClass({
	...
	render: function () {
		return React.createElement(
			"div",
			{ id: "sidebar-container", className: "debugger" },
			React.createElement(
				"div",
				{ id: "sidebar-pic-container" },
				React.createElement("img", { src: "assets/ecorpus.png" })
			),
			React.createElement(
				"div",
				{ className: "debugger sidebar-button" },
				React.createElement(
					"a",
					{ href: "https://www.linkedin.com/in/emiliocorpus", target: "_blank" },
					React.createElement("img", { src: "assets/linkedin-icon.png" })
				),
				React.createElement(
					"a",
					{ href: "https://github.com/emiliocorpus", target: "_blank" },
					React.createElement("img", { src: "assets/github-icon.png" })
				),
				React.createElement(
					"a",
					{ href: "https://twitter.com/uh_mili_oh", target: "_blank" },
					React.createElement("img", { src: "assets/twitter-icon.png" })
				)
			),
			React.createElement(AboutButton, { click: this.handleClicked }),
			React.createElement(ProjectsButton, { click: this.handleClicked }),
			React.createElement(BlogsButton, { click: this.handleClicked })
		);
	}
});
...
var Header = React.createClass({
	...
	render: function () {
		return React.createElement(
			"div",
			{ id: "header", className: "debugger" },
			React.createElement(
				"div",
				{ id: "header-title", className: "debugger" },
				"EMILIO CORPUS"
			),
			React.createElement(
				"div",
				{ id: "header-subtitle", className: "debugger" },
				React.createElement(
					"p",
					null,
					React.createElement(
...
var Page = React.createClass({
	...
	render: function () {
		return React.createElement(
			...
			React.createElement(Sidebar, { handleClick: this.receiveClick }),
			React.createElement(Content, { displayedContent: this.state.currentContent }),
