...
var AboutMeButton = React.createClass({
	displayName: "AboutMeButton",

	render: function () {
		return React.createElement(
			"a",
			{ href: "#body-container", id: "about-button", className: "debugger", onClick: this.handleClick },
			"About"
		);
	},
	handleClick: function () {
...
var AboutMeContainer = React.createClass({
	displayName: "AboutMeContainer",

	render: function () {
		return React.createElement(
			"div",
			{ id: "about-me-container", className: "debugger" },
			React.createElement(
				"div",
				{ id: "bio", className: "debugger" },
				React.createElement(
					"p",
					null,
					...
					". I would prefer any position that can provide me room to expand my technological knowledge and capacities. My current areas of expertise include Ruby on Rails and Object Oriented Javascript. "
				)
			),
			React.createElement(
				"div",
				{ id: "about-me-contact-container" },
				React.createElement(
					"div",
					{ id: "contact-images-container", className: "debugger" },
					React.createElement(
						"a",
						{ href: "http://www.twitter.com/uh_mili_oh" },
						React.createElement("img", { src: "/assets/twitter-icon.png", id: "twitter-icon" })
					),
					React.createElement(
						"a",
						{ href: "https://www.linkedin.com/in/emiliocorpus" },
						React.createElement("img", { src: "/assets/linkedin-icon.png", id: "linkedin-icon" })
					),
					React.createElement(
						"a",
						{ href: "http://www.github.com/emiliocorpus" },
						React.createElement("img", { src: "/assets/github-icon.png", id: "github-icon" })
					)
				),
				React.createElement(
					"div",
					{ id: "about-me-pic-container", className: "debugger" },
					React.createElement("img", { src: "/assets/ecorpus.png", id: "about-me-pic" })
				)
			),
			React.createElement(
				"div",
				{ id: "languages", className: "debugger about-section" },
				React.createElement(
					"h3",
					null,
					" Languages"
			...
			React.createElement(
				"div",
				{ id: "education", className: "debugger about-section" },
				React.createElement(
					"h3",
					null,
					" Education "
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								"li",
								null,
								"Peer Programming/Empathetic Engineering"
							),
							React.createElement(
								"li",
								null,
			...
			React.createElement(
				"div",
				{ id: "skills", className: "debugger about-section" },
				React.createElement(
					"h3",
					null,
					"Skillset"
			...
			React.createElement(
				"div",
				{ id: "summary", className: "debugger about-section" },
				React.createElement(
					"h3",
					null,
					"Summary"
			...
			React.createElement(
				"div",
				{ id: "experiences", className: "debugger about-section" },
				React.createElement(
					"h3",
					null,
					"Experiences"
			...
			React.createElement(
				"div",
				{ id: "Quirks", className: "debugger about-section" },
				React.createElement(
					"h3",
					null,
					"Quirks"
...
var BlogButton = React.createClass({
	displayName: "BlogButton",

	render: function () {
		return React.createElement(
			"a",
			{ href: "#body-container", id: "blog-button", className: "debugger", onClick: this.handleClick },
			"Blogs"
		);
	},
	handleClick: function () {
...
var Blog = React.createClass({
	...
	render: function () {
		return React.createElement(
			"div",
			{ className: "single-blog debugger" },
			React.createElement(
				"u",
				null,
				React.createElement(
	...
	loadCheck: function () {
		...
		if (this.state.blogs !== undefined) {
			blogs.map(function (index, el) {
				var blog = React.createElement(Blog, { data: blogs[el], key: blogs[el].id });
...
var BlogsContainer = React.createClass({
	displayName: "BlogsContainer",

	render: function () {
		return React.createElement(
			"div",
			{ id: "blogs-container", className: "debugger" },
			React.createElement(
				"div",
				null,
...
var Body = React.createClass({
	...
	render: function () {
		return React.createElement(
			"div",
			{ id: "body-container", className: "debugger" },
...
var Buttons = React.createClass({
	...
	render: function () {
		...
		if (this.state.currentPage === "about") {
			partial = React.createElement(AboutMeContainer, null);
		} else if (this.state.currentPage === "blogs") {
			partial = React.createElement(BlogsContainer, null);
		} else {
			partial = React.createElement(ProjectsContainer, null);
		}
		return React.createElement(
			"div",
			null,
			React.createElement(
				"div",
				{ id: "buttons-container", className: "debugger" },
				React.createElement(AboutMeButton, { receiveClick: this.receiveClick }),
				React.createElement(ProjectsButton, { receiveClick: this.receiveClick }),
				React.createElement(BlogButton, { receiveClick: this.receiveClick })
			),
			React.createElement(
				"div",
...
var ProjectsButton = React.createClass({
	displayName: "ProjectsButton",

	render: function () {
		return React.createElement(
			"a",
			{ href: "#body-container", id: "projects-button", className: "debugger", onClick: this.handleClick },
			"Projects"
		);
	},
	handleClick: function () {
	...
	loadCheck: function () {
		...
		if (this.state.projects !== undefined) {
			projects.map(function (index, el) {
				var project = React.createElement(Project, { data: projects[el], key: projects[el].id });
...
var ProjectsContainer = React.createClass({
	...
	render: function () {
		return React.createElement(
			"div",
			{ id: "projects-container", className: "debugger" },
...
var Project = React.createClass({
	...
	render: function () {
		return React.createElement(
			"div",
			{ className: "single-project debugger" },
			React.createElement(
				"a",
...
var Footer = React.createClass({
	...
	render: function () {
		return React.createElement(
			"div",
			{ id: "footer-container", className: "debugger" },
			React.createElement("br", null),
			React.createElement("hr", null),
			React.createElement(
				"p",
...
var HeadInfo = React.createClass({
	...
	render: function () {
		return React.createElement(
			"div",
			{ id: "header-info", className: "debugger" },
			React.createElement(
				"p",
				{ className: "debugger" },
				"Greetings and welcome! I am Emilio, an enthusiastic web developer and programmer. Thank you for giving my website a peek, please scroll down to learn more about me!"
			)
		);
	}
});
var Head = React.createClass({
	...
	render: function () {
		return React.createElement(
			"div",
			{ id: "header-container", className: "debugger" },
			React.createElement(PageTitle, null),
			React.createElement(ProfilePic, null),
			React.createElement(HeadInfo, null)
		);
	}
});
var PageTitle = React.createClass({
	...
	render: function () {
		return React.createElement(
			"div",
			{ id: "page-title", className: "debugger" },
			React.createElement(
				"h1",
				null,
				"EMILIO CORPUS"
			...
			React.createElement(
				"h3",
				null,
				"Freelance Web Developer | Seeking Employment"
			)
		);
	}
});
var ProfilePic = React.createClass({
	...
	render: function () {
		return React.createElement(
			"div",
			{ id: "header-pic-container", className: "debugger" },
			React.createElement("img", { src: "/assets/ecorpus.png", id: "header-pic", className: "debugger" })
		);
	}
});
...
var Page = React.createClass({
	...
	render: function () {
		return React.createElement(
			"div",
			{ className: "debugger", id: "page-container" },
