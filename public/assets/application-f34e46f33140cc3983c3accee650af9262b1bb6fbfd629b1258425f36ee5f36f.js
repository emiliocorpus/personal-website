...
var AboutMeButton = React.createClass({
	...
	render: function () {
		return React.createElement(
			"a",
			{ href: "#about", id: "about-button", className: "debugger", onClick: this.handleClick },
			"About"
		);
	},
	handleClick: function () {
...
var AboutMe = React.createClass({
	...
	render: function () {
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						"b",
						null,
						"am currently seeking full-time employment"
					),
			...
			React.createElement(
				"div",
				{ id: "languages", className: "debugger" },
				React.createElement(
					"h3",
					null,
					" Languages"
...
var BlogButton = React.createClass({
	...
	render: function () {
		return React.createElement(
			"a",
			{ href: "#blogs", id: "blog-button", className: "debugger", onClick: this.handleClick },
			"Blogs"
		);
	},
	handleClick: function () {
...
var ProjectsButton = React.createClass({
	...
	render: function () {
		return React.createElement(
			"a",
			{ href: "#projects", id: "projects-button", className: "debugger", onClick: this.handleClick },
			"Projects"
		);
	},
	handleClick: function () {
