...
#   Mayor.create(name: 'Emanuel', city: cities.first)
	...
	# 				)
	# }
	Project.create(name: 'Pokédex', description:"Designed with RoR and React.js, this app utilizes the FlipMove component library to animate when certain elements are removed/added to the virtual DOM. Currently only features first 151 Pokémon", url: "https://pokedex-on-react.herokuapp.com/", picture_url:'pokedex-screenshot.png')

	Project.create(name: 'Accounts Manager', description: 'Constructed with React.js, this application was made to better understand the interaction between state, props, and the virtual DOM in React.', url: "https://accounts-manager-on-react.herokuapp.com/", picture_url:"expense-tracker-screenshot.png")
